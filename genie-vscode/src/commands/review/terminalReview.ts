...
export function registerTerminalReviewCommand(
  ...
  const reviewDebug = vscode.commands.registerCommand(
    "extension.reviewDebug",
    async () => {
      if (isExecuting) {
        ...
        await vscode.window.withProgress(
          ...
          async (progress, cancel) => {
            ...
            try {
              ...
              if (wasCancelled) {
                vscode.window.showWarningMessage(
                  "Debug Review process was canceled."
                );
              }
            }
          }
  ...
  context.subscriptions.push(reviewDebug);
}
