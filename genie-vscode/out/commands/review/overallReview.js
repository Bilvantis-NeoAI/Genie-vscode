...
exports.registerOverallReviewCommand = registerOverallReviewCommand;
...
function registerOverallReviewCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const reviewOverall = await (0, reviewAPI_1.postOverallReview)(text, language, authToken);
                    ...
                    panel.webview.html = (0, reviewWebviewContent_1.reviewGetWebViewContent)(formattedContent, "Code Overall Review");
                });
            }
            catch (error) {
...
//# sourceMappingURL=overallReview.js.map