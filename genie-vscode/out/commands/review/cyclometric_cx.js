...
exports.registerCyclometricCXReviewCommand = registerCyclometricCXReviewCommand;
...
function registerCyclometricCXReviewCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const reviewCyclometricCX = await (0, reviewAPI_1.postCyclometricCXReview)(text, language, authToken);
                    ...
                    panel.webview.html = (0, reviewWebviewContent_1.reviewGetWebViewContent)(formattedContent, "Cyclometric-CX Review");
                });
            }
            catch (error) {
...
//# sourceMappingURL=cyclometric_cx.js.map