...
exports.registerCodeReviewCommand = registerCodeReviewCommand;
...
function registerCodeReviewCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const reviewComments = await (0, reviewAPI_1.postReviewCode)(text, language, authToken);
                    ...
                    panel.webview.html = (0, reviewWebviewContent_1.reviewGetWebViewContent)(formattedContent, "Code Review");
                });
            }
            catch (error) {
