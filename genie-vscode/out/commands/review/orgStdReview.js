...
exports.registerOrgStdReviewCommand = registerOrgStdReviewCommand;
...
function registerOrgStdReviewCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const reviewOrgStds = await (0, reviewAPI_1.postOrgStdReview)(text, language, authToken);
                    ...
                    panel.webview.html = (0, reviewWebviewContent_1.reviewGetWebViewContent)(formattedContent, "Org Std Review");
                });
            }
            catch (error) {
...
//# sourceMappingURL=orgStdReview.js.map