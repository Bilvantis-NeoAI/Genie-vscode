...
exports.registerSecurityReviewCommand = registerSecurityReviewCommand;
...
function registerSecurityReviewCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const reviewSecurity = await (0, reviewAPI_1.postSecurityReview)(text, language, authToken);
                    ...
                    panel.webview.html = (0, reviewWebviewContent_1.reviewGetWebViewContent)(formattedContent, "Security Review");
                });
            }
            catch (error) {
...
//# sourceMappingURL=securityReview.js.map