...
exports.registerErrorHandlingAssistantCommand = registerErrorHandlingAssistantCommand;
const vscode = __importStar(require("vscode"));
const assistantAPI_1 = require("../../utils/api/assistantAPI");
const addErrorHandlingAssistantWebviewContent_1 = require("../webview/assistant_webview/addErrorHandlingAssistantWebviewContent");
function registerErrorHandlingAssistantCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const response = await (0, assistantAPI_1.postAddErrorHandlingAssistant)(text, language, authToken);
                    ...
                    panel.webview.html = (0, addErrorHandlingAssistantWebviewContent_1.addErrorHandlingAssistantWebviewContent)(formattedContent, "Error Handling Assistant");
...
//# sourceMappingURL=addErrorHandlingAssistant.js.map