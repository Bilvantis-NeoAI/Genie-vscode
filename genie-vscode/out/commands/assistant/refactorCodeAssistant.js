...
exports.registerRefactorCodeAssistantCommand = registerRefactorCodeAssistantCommand;
const vscode = __importStar(require("vscode"));
const assistantAPI_1 = require("../../utils/api/assistantAPI");
const refactorCodeAssistantWebviewContent_1 = require("../webview/assistant_webview/refactorCodeAssistantWebviewContent");
function registerRefactorCodeAssistantCommand(context, authToken) {
        ...
        if (editor) {
            ...
            try {
                ...
                await vscode.window.withProgress(progressOptions, async () => {
                    const response = await (0, assistantAPI_1.postRefactorCodeAssistant)(text, language, authToken);
                    ...
                    panel.webview.html = (0, refactorCodeAssistantWebviewContent_1.refactorCodeAssistantWebviewContent)(formattedContent, "Refactor Code Assistant");
...
//# sourceMappingURL=refactorCodeAssistant.js.map